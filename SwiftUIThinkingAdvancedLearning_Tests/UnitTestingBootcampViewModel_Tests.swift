...
//  SwiftUIThinkingAdvancedLearning_Tests
//
...
import XCTest
@testable import SwiftUIThinkingAdvancedLearning
import Combine
...
class UnitTestingBootcampViewModel_Tests: XCTestCase {
    ...
    func test_UnitTestingBootcampViewModel_dataArray_shouldAddItems() {
        ...
        XCTAssertGreaterThan(vm.dataArray.count, 0) // มากกว่า
        // XCTAssertGreaterThanOrEqual
        // XCTAssertLessThan
        XCTAssertLessThanOrEqual(vm.dataArray.count, 0) // น้อยกว่า
    }
